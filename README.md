...
git clone [https://github.com/gabo-gil-playground/java-poc-email-sender-sample](https://github.com/gabo-gil-playground/java-poc-email-sender-sample)
...
# 3. Start the service (runs on port 9025 by default)
...
curl --request GET \
  --url http://localhost:9025/api/v1/email/send \
